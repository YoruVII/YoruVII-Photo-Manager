...
# Disclaimer
I have never coded before and have no clue what I am doing so make fun of my code and help me fix it if you see any issues if you find any bugs you can DM me at YoruVII on discord or make a issue. A LLM helped me to write this code so im sure some of it is stupid or not nessisary. And I have a few remnents of older code like how it checks file sizes but I can not be bothered to remove that right now. This is also a new program as of 4/15/2026 so it probably has bugs as I have not used it for long. (I suspect I need to account for prints and stickers and stuff but im poor and do not have VRC+ so ill find that issue in a public some time)
...
This program is not signed that costs money to my knowlage so windows is going to tell you it is a unknown publisher when you launch it ill look into signing.
